    ...
    <div>
      <div className="flex items-center justify-between gap-5">
        ...
        <AddNewCourse
          ...
          lang={lang}
          btn={dictionary.dashboard.admin.topbar.btn}
        />
      </div>
      ...
      <Tabs defaultValue="all">
        <TabsList className="mb-3 sm:mb-6">
          <TabsTrigger value="all">
            {dictionary.dashboard.admin.topbar.text1}
          </TabsTrigger>
          <TabsTrigger value="progres">
            {dictionary.dashboard.admin.topbar.text2}
          </TabsTrigger>
          <TabsTrigger value="archive">
            {dictionary.dashboard.admin.topbar.text3}
          </TabsTrigger>
        </TabsList>
