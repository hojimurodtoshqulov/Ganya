...
const SaveLesson: React.FC<Props> = ({ link, title }) => {
    return (
        <div className={clsx("rounded-2xl p-4 flex  flex-col space-y-4 bg-white grow")}>
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className={clsx('rounded-xl w-[60px] h-[60px] flex items-center justify-center bg-csneutral-100')} >
                ...
                <Link href={link} className="rounded-[8px] py-3 px-5 bg-red-200 text-red-500 text-sm font-normal ">Yangilash</Link>
