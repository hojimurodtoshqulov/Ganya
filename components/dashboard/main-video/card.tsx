...
const VideoCard = ({
  ...
  return (
    <>
      <article className=" group relative flex flex-col justify-end overflow-hidden rounded-sm max-w-sm mt-14 h-64">
        <video
          ...
          >
            ...
            <div className="flex gap-5 justify-end">
              {/* <Button
                ...
                variant={"outline"}
                className=" w-fit self-end capitalize border-destructive text-destructive"
