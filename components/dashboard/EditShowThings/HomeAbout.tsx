...
const schema = z.object({
    ...
    imgage: z.union([z.string(), z.instanceof(FileList)]),
});

type Schema = z.infer<typeof schema>;

const EditHomeAbout: React.FC<Props> = ({ type = 'showcase', defaultValues }) => {
    ...
    const onSubmit = (values: Schema) => {
        ...
        if (values.imgage instanceof FileList) {
            formData.append('image', values.imgage[0]);
        } else {
            formData.append('image', values.imgage[0]);
        }
    ...
    return (
        <div className="p-4 rounded-2xl bg-white flex flex-col gap-3 max-w-64 justify-between h-[292px]">
            ...
            <h1 className="text-lg text-csneutral-500">Фотография “О нас” на главной странице</h1>
